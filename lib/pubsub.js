...
exports.initRedisClients = function (options, callback) {
  ...
  controlClient.name = "CONTROL";     // TODO
  pubsubClient.name = "PUBSUB";
...
var renameNickFlow = flow.define(
  function tryAcquireNewNick(client, oldNick, newNick, callback) {
    this.client = client;
  ...
  function removeOldNickAddNewNickInSubscriptions(err, wasRemoved) {
    ...
    if (typeof this.client.subscriptions != "undefined" &&
        this.client.subscriptions.length > 0) {
      this.subs = Object.getOwnPropertyNames(this.client.subscriptions);
...
exports.changeNick = function (client, newNick, callback) {
  ...
  try {
    renameNickFlow(client, client.nickname, newNick, callback);
  } catch (e) {
